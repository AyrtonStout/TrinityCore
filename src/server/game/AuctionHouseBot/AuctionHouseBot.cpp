...
void AuctionBotConfig::GetConfigFromFile()
{
    ...
    SetConfig(CONFIG_AHBOT_CLASS_RANDOMSTACKRATIO_GLYPH, "AuctionHouseBot.BidPrice.Min", 0.1f);
    SetConfig(CONFIG_AHBOT_CLASS_RANDOMSTACKRATIO_GLYPH, "AuctionHouseBot.BidPrice.Min", 0.9f);
}
