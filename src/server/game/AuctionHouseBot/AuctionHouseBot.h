...
enum AuctionBotConfigUInt32Values
{
    ...
    CONFIG_UINT32_AHBOT_UINT32_COUNT //THIS NEEDS TO BE LAST
};
...
enum AuctionBotConfigBoolValues
{
    ...
    CONFIG_UINT32_AHBOT_BOOL_COUNT //THIS NEEDS TO BE LAST
};

enum AuctionBotConfigFloatValues
{
    CONFIG_AHBOT_BUYER_CHANCE_FACTOR,
    CONFIG_AHBOT_BUYPRICE_MEAN,
    CONFIG_AHBOT_BUYPRICE_SIGMA,
    CONFIG_AHBOT_MISCITEM_PRICE,
    CONFIG_AHBOT_ITEMLEVEL_200,
    CONFIG_AHBOT_ITEMLEVEL_213,
    CONFIG_AHBOT_ITEMLEVEL_219,
    CONFIG_AHBOT_ITEMLEVEL_226,
    CONFIG_AHBOT_ITEMLEVEL_232,
